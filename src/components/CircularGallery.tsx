...
class Media {
  ...
  onResize({ screen = this.screen, viewport = this.viewport } = {}) {
    ...
    this.plane.scale.y =
      (this.viewport.height * (1080 * this.scale)) / this.screen.height;
    this.plane.scale.x =
      (this.viewport.width * (1080 * this.scale)) / this.screen.width;
...
const urlMapping = {
  ...
  20: "https://link.dakshayanthra.in/CTF",
  ...
  26: "https://docs.google.com/forms/d/1H-_4L2Sk8RekB-MmJNg9eLXHlELhTPcTnF8hncYHo00/edit?usp=drivesdk",
  ...
  31: "https://link.dakshayanthra.in/TreasureHunt",
...
export default function CircularGallery({
  ...
  // Handle image click to navigate to a URL
